...
const { menusList } = useDashboardMenus()
const { statsList } = orderList()
const { tips } = useShopTips()
const { transactionTips } = useTransactionTips()
onMounted(() => {
 setTimeout(() => {
...
import { useOrderChart } from '@/composable/useManager'
